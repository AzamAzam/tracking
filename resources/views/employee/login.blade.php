							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Login to employee panel</h3>
										...
										<div class="form-wrap">
											<form method="post" action="{{ route('employeeLogin') }}">
												...
												<div class="form-group">
													...
													<a class="capitalize-font txt-primary block mb-10 pull-right font-12" href="ForgotPassword.html">forgot password ?</a>
													<div class="clearfix"></div>
