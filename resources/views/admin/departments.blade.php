...
<body>
							...
							<div class="panel-heading">
								<div class="pull-left">
									<div class="row">
										...
										<div class="col-md-4">
											<button class="btn  btn-primary btn-rounded" class="model_img img-responsive" id="newDepartmentOpenButton">New Department</button>
										</div>
									</div>
								</div>
							</div>
												...
												<tbody>
													...
													<tr>
														...
														<td class="text-nowrap">
															<a href="#" data-toggle="modal" class="view-DepartmentModel mr-25" data-id="{{ $row->departmentID }}">
																<i class="fa fa-eye text-inverse m-r-10"></i> 
															</a> 
															<a href="#" data-toggle="modal" class="edit-DepartmentModel mr-25" data-id="{{ $row->departmentID }}">
																<i class="fa fa-pencil text-inverse m-r-10"></i> 
															</a>
															<a href="#" data-toggle="modal" class="delete-DepartmentModel" data-id="{{ $row->departmentID }}">
      		...
      		<div class="modal-content">
        		<div class="modal-header">
        			<button type="button" class="close" data-dismiss="modal">&times;</button>
          			<h4 class="modal-title"><h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Add New Department</h6></h4>
        		</div>
        	<form method="post" action="{{ route('adminDepartment_new') }}">
        		@csrf
        		<!-- Modal body Add-->
        				...
        				<div class="col-sm-12 col-xs-12">
        						...
        						<div class="form-body">
        							...
        							<div class="row">
        								...
        								<div class="col-md-8">
        									<div class="form-group">
        									<label class="control-label mb-10">Hours</label>
        									<input type="text" name="addHours" class="form-control" required="">
        								</div>
        								</div>
        								<div class="col-md-2"></div>
        							</div>
        		...
        		<div class="modal-footer">
        			<button type="submit" class="btn btn-primary text-left" id="addDepartmentButton">Save</button>
    ...
    <!-- Modal View -->
  	<div class="modal fade" id="viewDepartment" role="dialog">
  		<div class="modal-dialog">
  			<!-- Modal content View-->
      		<div class="modal-content">
        		<div class="modal-header">
        			<button type="button" class="close" data-dismiss="modal">&times;</button>
          			<h4 class="modal-title"><h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>View Department's Info</h6></h4>
        		</div>
        		<!-- Modal body View-->
        		<div class="modal-body">
        			<!-- Row -->
  	...
  	<div class="modal fade" id="editDepartment" role="dialog">
  		<div class="modal-dialog">
      		...
      		<div class="modal-content">
        		<div class="modal-header">
        			<button type="button" class="close" data-dismiss="modal">&times;</button>
          			<h4 class="modal-title"><h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Edit Department's Info</h6></h4>
        		</div>
        		<!-- Modal body Edit-->
        		<div class="modal-body">
        			<!-- Row -->
        							...
        							<table class="table table-hover table-bordered mb-0">
        								<thead>
        									...
        									<tr>
        										<th>Hours</th>
        									 	<td>
        									 		<input type="text" id="editHours" class="form-control" value="">
        									 	</td>
        									</tr>
        								</thead>
        							</table>
        		...
        		<!-- /Modal body Edit-->
        		<div class="modal-footer">
        			<button type="button" class="btn btn-primary text-left" id="editDepartmentButton">Save</button>
          			<button type="button" class="btn btn-danger text-left" data-dismiss="modal">Close</button>
        		</div>
      		</div>
      		<!-- /Modal content Edit-->
  	...
  	<div class="modal fade" id="deleteDepartment" role="dialog">
  		<div class="modal-dialog">
      		...
      		<div class="modal-content">
        		<div class="modal-header">
        			<button type="button" class="close" data-dismiss="modal">&times;</button>
          			<h4 class="modal-title"><h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Delete Department's Info</h6></h4>
        		</div>
        		<!-- Modal body delete-->
        		<div class="modal-body">
        			<!-- Row -->
        		...
        		<!-- /Modal body delete-->
        		<div class="modal-footer">
        			<button type="button" class="btn btn-danger text-left" id="deleteDepartmentButton">Yes</button>
