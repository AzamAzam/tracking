				...
				<div class="row">
									...
									<div class="profile-box">
										...
										<div class="profile-info text-center">
											<div class="profile-img-wrap">
												<img class="inline-block mb-10" src="{{ URL::asset('public/dist/img/user1.png') }}" alt="user"/>
												<div class="fileupload btn btn-default">
													<span class="btn-text">edit</span>
													<input class="upload" type="file">
												</div>
											</div>
											<h5 class="block mt-10 mb-5 weight-500 capitalize-font txt-danger">Tracking System</h5>
											<h6 class="block capitalize-font pb-20">Developed By <a href="http://www.hiddenlogics.com/" target="next">Hidden Logics</a></h6>
											<button type="button" data-toggle="modal" data-target="#question" class="btn btn-success mr-10 mb-30">Security Question</button>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-9 col-xs-12">
						<div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="form-wrap">
									<form method="post" action="{{ route('admin_profileUpdate') }}">
										@csrf
										...
										<div class="form-group">
											...
											<div class="input-group">
												<div class="input-group-addon"><i class="zmdi zmdi-comment-text"></i></div>
      		...
      		<div class="modal-content">
        		<div class="modal-header">
        			<button type="button" class="close" data-dismiss="modal">&times;</button>
          			<h4 class="modal-title"><h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Security Question</h6></h4>
        		</div>
        	<form method="post" action="{{ route('admin_Question') }}">
        		@csrf
        		<!-- Modal body Add-->
        				...
        				<div class="col-sm-12 col-xs-12">
        						<div class="form-body">
        							...
        							<div class="row">
        								...
        								<div class="col-md-8">
        									<div class="form-group">
        									<label class="control-label mb-10">Answer</label>
